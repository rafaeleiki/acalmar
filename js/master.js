        ...
        var menu = $(`
            <div>
                <nav class="bar bar-tab">
                    ...
                    <a class="tab-item ${tab === 'diario' ? 'active' : undefined}" href="pages/diario.html" data-transition="slide-in">
                        <span class="fa fa-pencil"></span>
                        <span class="tab-label">Diário</span>
                    </a>
                    <a class="tab-item ${tab === 'acalmar' ? 'active' : undefined}" href="pages/acalmar.html" data-transition="slide-in">
                        <span class="fa fa-leaf"></span>
                        <span class="tab-label">Acalmar</span>
                    </a>
                    <a class="tab-item ${tab === 'assistencia' ? 'active' : undefined}" href="pages/assistencia.html" data-transition="slide-in">
